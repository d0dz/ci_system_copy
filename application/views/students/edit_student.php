		...
		<div class="span12">
			<div class="well">
				...
				<center>
					...
					<form action="<?=base_url()?>students/edit/<?=$student['std_id']?>" method="post">

						<p>ชื่อ : <input name="std_name" type="text" value="<?=$student['std_name']?>"></p>
						<!-- <p>รหัสนักเรียน : <input name="std_number" type="text" /></p> -->
						<p>อีเมลล์ : <input name="std_email" type="text" value="<?=$student['std_email']?>"></p>
						<p>โทรศัพท์ : <input name="std_tel" type="text" value="<?=$student['std_tel']?>"></p>
