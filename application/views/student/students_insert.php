							...
							<table width="1276" align="center">
								...
								<tr>
								  ...
								  <td><?php 
									...
									echo form_dropdown('txt_antecedent', $options, $txt_antecedent);
								 
								 ?>
                                    <span class="style1">*</span> </td>
								  <td><div align="right">ชื่อ - นามสกุล : </div></td>
								  <td><input type="text" name="txt_name" value="<?php echo set_value("txt_name"); ?>">
								...
								<tr>
								  ...
								  <td width="397">
								    ...
								    <input  type="text" name="txt_number" value="<?php echo set_value("txt_number"); ?>"/>
									...
									<td width="301"><input type="text" name="txt_tel" value="<?php echo set_value("txt_tel"); ?>"/>
                                      <span class="style1">*</span><br><?php echo form_error("txt_tel", "<font color='error'>", "</font>"); ?>
									</td>
							  </tr>
								<tr>
                                  <td height="24"><div align="right">อีเมลล์ : </div></td>
                                  <td><input type="text" name="txt_email" value="<?php echo set_value("txt_email"); ?>"/>
                                  ...
                                  <td><?php 
									...
									echo form_dropdown('txt_class', $options , $txt_class);
								 ...
								 ?>
									...
									<tr>
									  ...
									  <td><input type="text" name="txt_room" value="<?php echo set_value("txt_room"); ?>">
									...
									<tr>
									  ...
									  <td><textarea name="txt_address" value="<?php echo set_value("txt_address"); ?>"></textarea>
									  ...
									  <td><input type="text" name="txt_provice" value="<?php echo set_value("txt_provice"); ?>"/>
									...
									<tr>
									  ...
									  <td><input type="text" name="txt_zipcode" value="<?php echo set_value("txt_zipcode"); ?>"/>
